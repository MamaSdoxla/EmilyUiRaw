...
return function(Library, ui)
    ...
    local AimBtn = Library.CreateButton(ui.SideBar, "Aim", function() end)
    ...
    local function createESP(player)
        ...
        local highlight = create("Highlight", {Name = "AimbotESP_Highlight", DepthMode = Enum.HighlightDepthMode.AlwaysOnTop, FillColor = ESPSettings.Color, FillTransparency = 0.7, OutlineColor = Color3.new(1, 1, 1), Parent = player.Character})
    ...
    return { Tabs = aimTabs, Gather = function() return { Legit = Legit, Rage = Rage, ESP = ESPSettings } end, Apply = function(data)
    ...
    end, Reset = function() Legit.Enabled = false; Rage.Enabled = false; ESPSettings.Enabled = false end }
end