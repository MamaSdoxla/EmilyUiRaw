...
local LocalPlayer=Core.LocalPlayer; local RunService=Core.RunService; local HttpService=Core.HttpService; local UserInputService=Core.UserInputService
...
local Music=Core.SideButtons.Music
...
local desyncTabs=Core.DesyncTabs or {}
local MusicKeybinds=Core.MusicKeybinds or {Toggle=""}; Core.MusicKeybinds=MusicKeybinds
...
Core.MusicTabs=musicTabs

Core.RegisterModule("Music",Music,Core.MusicTabs,Core.MusicTabs and Core.MusicTabs[1])
