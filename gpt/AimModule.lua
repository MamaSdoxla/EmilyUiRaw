...
local ScreenGui=Core.ScreenGui; local MenuInsided=Core.MenuInsided; local Containment=Core.Containment; local tabs=Core.tabs
...
local Aim=Core.SideButtons.Aim
...
local desyncTabs=Core.DesyncTabs or {}; local musicTabs=Core.MusicTabs or {}
...
Core.AimAPI = initAimbotModule(desyncTabs, musicTabs)

Core.RegisterModule("Aim",Aim,Core.AimAPI and Core.AimAPI.Tabs,Core.AimAPI and Core.AimAPI.Tabs and Core.AimAPI.Tabs[1])
