...
local LocalPlayer=Core.LocalPlayer; local Players=Core.Players; local RunService=Core.RunService; local UserInputService=Core.UserInputService; local HttpService=Core.HttpService
local ScreenGui=Core.ScreenGui; local MenuInsided=Core.MenuInsided; local Containment=Core.Containment
...
local desyncTabs=Core.DesyncTabs or {}; local musicTabs=Core.MusicTabs or {}; local AimAPI=Core.AimAPI
...
local function initMovementModule(desyncTabs, musicTabs, aimTabs)
	...
	local Movement = Core.SideButtons.Movement or Core.makeSideBtn("Movement", 236)
...
Core.MovementAPI = initMovementModule(desyncTabs, musicTabs, AimAPI and AimAPI.Tabs or {})


Core.RegisterModule("Movement",Core.SideButtons.Movement,Core.MovementAPI and Core.MovementAPI.Tabs,Core.MovementAPI and Core.MovementAPI.Tabs and Core.MovementAPI.Tabs[1])
Core.Finalize()
